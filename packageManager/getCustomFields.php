...
$query ="SELECT name, custom_module, type, date_modified FROM fields_meta_data WHERE deleted = 0 ";
...
$header = "<thead><tr><th>Name</th><th>Module</th><th>Type</th><th>Date Modified</th></tr></thead>";
$return_value = "<table id='customfield_table' class='row-border' cellspacing='0'>";
