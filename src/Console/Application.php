...
//        $commands[] = new \SugarCli\Console\Command\Inventory\FacterCommand();
        ...
        $commands[] = new \SugarCli\Console\Command\SystemResetPermissionsCommand();
        $commands[] = new \SugarCli\Console\Command\Install\SystemBackupCommand();
        $commands[] = new \SugarCli\Console\Command\Install\SystemRestoreCommand();
        $commands[] = new \SugarCli\Console\Command\Install\SystemSafetyCommand();
        $commands[] = new \SugarCli\Console\Command\SystemSetUserPasswordsCommand();
        $commands[] = new \SugarCli\Console\Command\SystemClearCacheCommand();
